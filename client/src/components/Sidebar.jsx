...
import { FiHome, FiCreditCard, FiClock, FiLogOut, FiUsers, FiSettings } from 'react-icons/fi';
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-full shadow-sm sticky top-0">
      <div className="h-16 flex items-center px-6 border-b border-gray-100 bg-brand-50">
